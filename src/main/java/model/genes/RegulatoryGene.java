...
/**
 * This interface represents a regulatory gene, which extends the basic gene
 * interface and includes methods
 * for managing a gene's regulation.
 */
public interface RegulatoryGene extends BasicGene {
  /**
   * Check if this regulatory gene is currently signaled, i.e., is influenced by
   * its regulator.
   *
   ...
   *
   * @param isSignaled {@code true} to signal the gene, {@code false} to
   *                   deactivate it.
   */
